          ...
          <form @submit.prevent="enviar" @reset="resetar">
            ...
            <div class="form-group">
              ...
              <select class="form-control" v-model="desenvolvedor.ocupacao">
                ...
                <option v-for="(ocupacao,indice) in ocupacoes" :key="indice">
                {{ocupacao}}</option>
              </select>
            </div>
            ...
            <div class="form-group">
              <div class="form-check form-check-inline">
                ...
                true-value="Sim"
                false-value="Não"
                v-model="desenvolvedor.notificacao">
        ...
        <div class="col-sm-6">
          ...
          <div class="card">
            ...
            <ul class="list-group list-group-flush">
              ...
              <li class="list-group-item">
                <strong>Receber notificações?</strong>{{desenvolvedor.notificacao}}
              </li>
              <li class="list-group-item">
                <strong>Salário pretendido:</strong> {{desenvolvedor.salario}}
              </li>
            </ul>
...
export default {
 ...
 AppRange
  ...
  methods:{
    enviar(event){
      const formularioSelecionado = Object.assign({}, this.desenvolvedor)
      console.log('Formulario enviado ',formularioSelecionado)
    },
    resetar(){
